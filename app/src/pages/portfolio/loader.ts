...
export const GetPortfolioItemsLoader: LoaderFunction = async () => {
    ...
    console.log(`${BASE}${GET_PORTFOLIO_ITEMS}`);
    console.log("http://localhost:8000/projects/api/get_portfolio_items/")
    const d = await fetch(`http://localhost:8000/projects/api/get_portfolio_items/`, {
        method: "GET",
        mode: "cors"
    });
