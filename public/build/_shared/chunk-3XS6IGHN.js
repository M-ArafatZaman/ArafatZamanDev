...
function createRouter(init) {
  ...
  async function callLoadersAndMaybeResolveData(currentMatches, matches, matchesToLoad, fetchersToLoad, request) {
    let results = await Promise.all([...matchesToLoad.map((match) => callLoaderOrAction("loader", request, match, matches, router2.basename)), ...fetchersToLoad.map((f) => {
      if (f.matches && f.match) {
        return callLoaderOrAction("loader", createClientSideRequest(init.history, f.path, request.signal), f.match, f.matches, router2.basename);
      } else {
        let error = {
          type: ResultType.error,
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useState5 = React6.useState, useEffect5 = React6.useEffect, useLayoutEffect4 = React6.useLayoutEffect, useDebugValue2 = React6.useDebugValue;
...
//# sourceMappingURL=/build/_shared/chunk-3XS6IGHN.js.map
